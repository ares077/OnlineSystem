		...
		<div class="div2">
			...
			<div class="tablediv">
				<table class="table1" border="1">
					<caption>
						<span class="span1">Now <%=nowPage%> Page</span>
					</caption>
					<tr class="tr1">
						<td width="50">
							No d'examen
				...
				<div class="divpage">
				<a href="note/notelist.xiu?nowPage=1">Home Page</a>&nbsp;
				<a href="note/notelist.xiu?nowPage=<%=nowPage - 1%>">Précédent</a>&nbsp;
				<a href="note/notelist.xiu?nowPage=<%=nowPage + 1%>">suivant</a>&nbsp;
				<a href="note/notelist.xiu?nowPage=<%=Integer.MAX_VALUE%>">Dernière</a>&nbsp;
