...
%>
<%
	int nowPN = Integer.parseInt(session.getAttribute("nowPN").toString());
%>
...
<html>
  ...
  <script type="text/javascript" src="javascript/admin/notelists2/notelists2.js"></script>
  </head>
		...
		<div class="div5">
			...
			<div class="tablediv">
					<table class="table1" border="1">
						<caption>
							<span class="span1">当前是第 </span><span id="nowPN" class="span1"> <%=nowPN%> </span><span class="span1"> 页记录</span>
						</caption>
						<tr class="tr1">
							<td width="50">
								成绩编号
						...
						<tr class="row${s.index%2+1}">
								...
								<td>
							<span style="color:green">	<s:property value="studentid"/> </span>
								</td>
								<td>
