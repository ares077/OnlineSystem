...
%>
<%
	int nowPageQ2 = Integer.parseInt(session.getAttribute("nowPageQ2").toString());
%>
			...
			<div class="div3">
				...
				<div class="selectdiv">
					<form action="question/questionlists2" method="post">
						...
						<select name="level" id="level">
							<option value="<s:property value="level" />"><s:property value="level" /></option>
							<option value="A1">
								A1
							</option>
							<option value="A2">
						...
						<input name="key" placeholder="请输入关键字" id="key"  value="<s:property value="key" />"/>
				...
				<div class="tablediv">
					<table class="table1" border="1">
						<caption>
							<span class="span1">当前是第 </span><span id="nowPageQ2" class="span1"> <%=nowPageQ2%> </span><span class="span1"> 页记录</span>
						</caption>
						<tr class="tr1">
							<td width="50">
								题目编号
